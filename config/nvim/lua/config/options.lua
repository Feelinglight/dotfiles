...
opt.updatetime = 4000 -- Save swap file and trigger CursorHold
...
opt.textwidth = 100
opt.colorcolumn = "+1"
-- vim.highlight.create('ColorColumn', {ctermbg=lightgrey, guibg=lightgrey}, false)
